...
function Event({e,id,weather}) {
  return (
    <div className="w-80 sm:w-96 h-[350px] bg-[#ffffff] border border-[#BOBABF] rounded-lg mx-auto sm:mx-4 relative">
        <img src={`https://drive.google.com/thumbnail?id=${id}&sz=w1000`} alt="img"></img>
        <div className='absolute top-[230px] rounded-t-none rounded-b-lg left-[4.5%] text-white w-[91%] bg-[rgba(49,49,49,0.8)] p-1'>
